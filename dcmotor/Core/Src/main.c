...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  pwm_val2=50;
	  HAL_GPIO_WritePin(GPIOC, dc1_Pin, 1);
	  HAL_GPIO_WritePin(GPIOC, dc2_Pin, 0);
	  HAL_GPIO_WritePin(GPIOA, dc3_Pin, 0);
	  HAL_GPIO_WritePin(GPIOA, dc4_Pin, 1);
	  HAL_Delay(300);
    /* USER CODE END WHILE */
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, dc3_Pin|dc4_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : dc3_Pin dc4_Pin */
  GPIO_InitStruct.Pin = dc3_Pin|dc4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
